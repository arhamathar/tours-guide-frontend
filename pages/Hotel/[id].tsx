        ...
        <div className='flex flex-col'>
            <div className='flex justify-between md:justify-evenly items-center  shadow-sm bg-white'>
                <div className='flex  md:space-x-1 md:font-bold p-2'>
                    <span>
                        <SiYourtraveldottv
                            style={{ color: '#FF385C', fontSize: '1rem' }}
                        />
                    </span>
                    <span style={{ color: '#FF385C', fontSize: '1.5rem' }}>
                        Travel Site
                    </span>
                </div>
            ...
            <div className='space-y-3 pt-0 mt-0 md:ml-40 md:pt-12 md:flex md:flex-col md:space-y-7'>
                <div className='hidden md:block'>
                    <h1 className='text-black-900 font-semibold text-2xl font-mono'>
                        {hotel.hotelName}
                    </h1>
                </div>
                ...
                <div className='pt-3 ml-6 flex w-11/12 md:w-10/12 justify-between space-x-12'>
                    <div className='flex flex-col space-y-8 w-11/12 divide-y md:w-7/12 md:space-y-12'>
                        <div>
                            <h1 className='text-black-900 font-semibold text-xl font-mono'>
                        ...
                        <div className='flex flex-col space-y-8 pt-6 md:pt-12'>
                            ...
                            <div>
                                ...
                                <h1 className='text-black-100 font-sans'>
                                    {hotel.bed} double bed, {hotel.bed} sofa, 1
                                    floor mattress
                                </h1>
                            </div>
                        </div>
                        ...
                        <div className='flex flex-col space-y-4 px-12 py-5'>
                            <div className='flex justify-between'>
                                <h1 className='underline'>
                                    ₹{hotel.price} x {noOfDays} nights x {rooms}{' '}
                                    rooms
                                </h1>
                                <h1>₹{hotel.price * noOfDays * rooms}</h1>
                            </div>
                            <div className='flex justify-between'>
                                <h1 className='underline'>Weekly discount</h1>
