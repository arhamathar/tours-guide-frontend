...
import {GiVacuumCleaner,GiWeightLiftingUp,GiLift,GiSmokeBomb} from 'react-icons/gi'
import {RiDoorLockBoxFill,RiParkingBoxFill,RiComputerFill} from 'react-icons/ri'
...
export const getStaticPaths = async() => {
    const res = await axios.get('http://localhost:3000/api/v1/hotel/getAllHotels');
...
export const getStaticProps = async(context:any) => {
    ...
    const res = await axios.get('http://localhost:3000/api/v1/hotel/getHotelDetails/' +id);
...
const Hotel = ({hotel}) => {
   ...
   const router=useRouter();
    ...
    const {
        ...
        loading,
        error
    } = useReviewScrolling(pageNumber,router.query.id)
         ...
         <div className='flex flex-col'>
             ...
             <div className='space-y-3 pt-0 mt-0 md:ml-40 md:pt-12 md:flex md:flex-col md:space-y-7'>
                 <div className='hidden md:block'>
                    <h1 className='text-black-900 font-semibold text-2xl font-mono'>{hotel.hotelName}</h1>
                 </div>
                 <div className='hidden  md:flex space-x-4 items-center cursor-pointer'>
                    <h1><span><AiFillStar style={{color:"#FF385C", fontSize: "1rem"}}/></span></h1>
                    <h1 className='font-sm md:font-semibold'>   5.0(20 reviews)</h1>
                    <div>
                     <h1 className='text-gray-400 underline font-semibold'>{hotel.locations.address}</h1>
                    </div>
                 </div>
                 ...
                 <div className="pt-3 ml-6 flex w-11/12 md:w-10/12 justify-between space-x-12">
                    <div className="flex flex-col space-y-8 w-11/12 divide-y md:w-7/12 md:space-y-12">
                        <div>
                            <h1 className='text-black-900 font-semibold text-xl font-mono'>Fully Furnished Luxurious Room</h1>
                            <h1 className='text-black-100 text-md font-sans'>{hotel.bed} bedroom. {hotel.bed} bed. {hotel.bathroom} bathroom</h1>
                        </div>
                        <div className="flex flex-col pt-6 md:pt-12 space-y-10">
                            <div className="flex space-x-8">
                                <h1><span><GiVacuumCleaner style={{fontSize: "1rem"}}/></span></h1>
                                <div className="flex flex-col space-y-1">
                                    <h1 className='font-bold text-black-500'> Enhanced Clean</h1>
                                    <h1 className='text-gray-600'>This host has committed to Airbnb's 5-step enhanced cleaning process.</h1>
                                </div>
                            </div>
                            <div className="flex space-x-8">
                                <h1><span><RiDoorLockBoxFill style={{fontSize: "1rem"}}/></span></h1>
                                <div className="flex flex-col space-y-1">
                                    <h1 className='font-bold text-black-500'> Self check-in</h1>
                                    <h1 className='text-gray-600'>Check yourself in with the lockbox.</h1>
                                </div>
                            </div>
                            <div className="flex space-x-8">
                                <h1><span><MdFreeCancellation style={{fontSize: "1rem"}}/></span></h1>
                                <div className="flex flex-col space-y-1">
                                    <h1 className='font-bold text-black-500'> Free cancellation for 48 hours</h1>
                                    <h1 className='text-gray-600'>Your whole money will be refunded</h1>
                                </div>
                            </div>
                        </div>
                        <div className="flex flex-col pt-6 md:pt-12 space-y-4 md:space-y-8">
                            <h1 className='text-black-900 font-semibold text-xl font-mono'>Hotel Description</h1>
                            <p>{hotel.description}</p>
                        </div>
                        <div className="flex flex-col space-y-8 pt-6 md:pt-12">
                            <h1 className='text-black-900 font-semibold text-xl font-mono'>Where you'll sleep</h1>
                            <div>
                                <Image
                                    src={"https://media.istockphoto.com/photos/interior-of-a-modern-luxury-hotel-double-bed-bedroom-picture-id1163498940?k=20&m=1163498940&s=612x612&w=0&h=tUPidNW2ny095sCR97dur7cbrCnYpcjHbevUTJyB8Jc="}
                                ...
                                <h1 className="font-bold text-black">Bedroom area</h1>
                                <h1 className='text-black-100 font-sans'>{hotel.bed} double bed, {hotel.bed} sofa, 1 floor mattress</h1>
                            </div>
                        </div>
                        <div className="flex flex-col space-y-8 pt-6 md:pt-12">
                            <h1 className='text-black-900 font-semibold text-xl font-mono'>What this place offers</h1>
                            <div className='grid grid-cols-1 grid-flow-row md:grid-rows-5  md:grid-flow-col gap-4'>
                                <div className="flex space-x-6 items-center">
                                     <h1><FaUmbrellaBeach /></h1>
                                     <h1>Beach Access</h1>
                                </div>
                                <div className="flex space-x-6 items-center">
                                     <h1><AiOutlineWifi /></h1>
                                ...
                                <div className="flex space-x-6 items-center">
                                     <h1><MdOutlineKitchen /></h1>
                                     <h1>Kitchen</h1>
                                </div>
                                <div className="flex space-x-6 items-center">
                                     <h1><RiParkingBoxFill /></h1>
                                     <h1>Free on-street parking</h1>
                                </div>
                                <div className="flex space-x-6 items-center">
                                     <h1><RiComputerFill /></h1>
                                     <h1>TV</h1>
                                </div>
                                <div className="flex space-x-6 items-center">
                                     <h1><BsController /></h1>
                        ...
                        <div className="hidden md:flex flex-col space-y-8 pt-12">
                            <div>
                                <h1 className='text-black-900 font-semibold text-xl font-mono'>Now Its Time To Select The Dates</h1>
                            </div>
                            <div>
                                <DateRangePicker
                        ...
                        <div className="bg-white border border-solid shadow-lg shadow-gray-900 rounded-lg border-inherit hidden md:flex md:flex-col space-y-3 w-5/12 h-3/4">
                            <div className="flex justify-around  pt-7">
                               <h1 className='font-bold text-2xl text-black'>₹{hotel.price}/night</h1>
                               <div className='flex space-x-4 items-center cursor-pointer'>
                                    <h1><span><AiFillStar style={{color:"#FF385C", fontSize: "1rem"}}/></span></h1>
                                    <h1 className='font-semibold'>   5.0(20 reviews)</h1>
                               </div>
                            </div>
                            <div className="grid grid-cols-2 gap-x-1  px-12 py-4">
                                <div className='col-span-1 flex flex-col space-y-1 items-center  border rounded-lg border-black'>
                                    <h1 className='text-xs font-bold'>CHECK-IN</h1>
                                    <h1>{startDate.getDate()}</h1>
                                </div>
                                <div className='col-span-1 flex flex-col space-y-1 items-center  border rounded-lg border-black'>
                                    <h1 className='text-xs font-bold'>CHECK-OUT</h1>
                                    <h1>{endDate.getDate()}</h1>
                                </div>
                                <div className='col-span-2 flex flex-col space-y-1 items-center  border rounded-lg border-black'>
                                    <h1 className='text-xs font-bold'>Number of Rooms</h1>
                                    <input className="border-0" value={noOfRooms} onChange={(e)=>{setNoOfRooms(e.target.value)}}>
                                    </input>
                                </div>
                            </div>
                            <div className='px-12 py-4'>
                                <button className="rounded-lg text-white bg-pink-600 w-full h-10" onClick={payment}>
                                    Reserve
                                </button>
                            </div>
                            <div className="flex flex-col space-y-4 px-12 py-5">
                                 <div className='flex justify-between'>
                                     <h1 className='underline'>
                                        ₹{hotel.price} x {noOfDays} nights x {rooms} rooms
                                     </h1>
                                     <h1>
                            ...
                            <div className='flex justify-between px-12 py-5'>
                                ...
                                <h1 className="font-bold text-black">
                                    ₹{Math.round((hotel.price*noOfDays*rooms)+((hotel.price*noOfDays)/10)+(hotel.price/1000))}
                                </h1>
                            </div>
                        </div>
                 </div>
                 <div className="ml-6 w-10/12 flex flex-col pt-6 md:pt-12">
                     <div className="flex space-x-5 items-center">
                        <h1><span><AiFillStar style={{color:"#FF385C", fontSize: "1rem"}}/></span></h1>
                        <h1 className='font-bold text-2xl'>   5.0(20 reviews)</h1>
                     </div>
                     ...
                     <div className="grid grid-cols-1 md:grid-cols-2 grid-flow-row gap-12 py-12">
                        {reviews.map((review, index) => {
                            if (reviews.length === index + 1) {
                                return ( <div ref={lastReview} className="flex flex-col">
